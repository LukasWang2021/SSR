...
int main()
{
    ...
    cout << "Please cin hash type : "<< endl 
        << "1: /rpc/coordinate_manager/addUserCoord, hash = 0x0000A22C;" << endl
        << "2: /rpc/coordinate_manager/updateUserCoord, hash = 0x0000C78C" << endl;
    cin >> hash_cin;

    unsigned int hash_value = 0;
    if (1 == hash_cin)
        hash_value = 0x0000A22C;
    else if (2 == hash_cin)
        hash_value = 0x0000C78C;
    else
    {
    ...
    cout << "Please input id, from 1 to 10:" << endl;
    int id = 0;
    cin >> id;
    msg.data.id = id;
