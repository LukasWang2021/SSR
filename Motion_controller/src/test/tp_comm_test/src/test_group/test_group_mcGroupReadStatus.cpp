...
int main(int argc, char* argv[])
{
    if (argc <= 1)
    {
        cout << "1 parameters are needed: group_id" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x00002A83;
    ...
    ResponseMessageType_Uint64_GroupStatus_Bool recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_GroupStatus_Bool_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data1 group_status = " <<recv_msg.data1 << endl;
    cout << "Reply : msg.data2 in_position = " <<recv_msg.data2.data << endl;
