...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x00017063;

    RequestMessageType_Int32List_Int32List msg;
    ...
    msg.data2.data_count = 512;
    for (unsigned int i = 0; i < msg.data2.data_count; ++i)
    {
        msg.data2.data[i] = 0;
    }

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_Int32List_Int32List_fields, buf, buf_size))
    {
