...
{    
    if (!yaml_help_.loadParamFile(file_path_.c_str())
        ...
        || !yaml_help_.getParam("online_traj_cycle_time", online_traj_cycle_time_)
        || !yaml_help_.getParam("dev_process_cycle_time", dev_process_cycle_time_)
        ...
        || !yaml_help_.getParam("online_traj_thread_priority", online_traj_thread_priority_)
        || !yaml_help_.getParam("dev_process_thread_priority", dev_process_thread_priority_)
