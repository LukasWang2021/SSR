...
int main(int argc, char* argv[])
{
    ...
    {
        cout << "more parameters are needed : rpc hash index, start id, end id" << endl;
    ...
    cout << "Reply : msg.header.error_code = 0x" << std::hex << recv_msg.header.error_code << endl;
    cout << "Reply : msg.property.authority = " << recv_msg.property.authority << endl;
    cout << "Reply : msg.error_code.data = 0x" << std::hex << recv_msg.error_code.data << endl;
