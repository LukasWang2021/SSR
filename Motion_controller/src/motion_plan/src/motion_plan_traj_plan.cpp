...
ErrorCode computeAlphaLimit(const double *joint, const double *omega, double *a_upper, double *a_lower)
{
    ...
    {
    	double ratio = 1;
        a_upper[0] = alpha_limit[0][0] * ratio;
        a_upper[1] = alpha_limit[0][1] * ratio;
        a_upper[2] = alpha_limit[1][2] * ratio;
        a_upper[3] = alpha_limit[0][3] * ratio;
        a_upper[4] = alpha_limit[0][4] * ratio;
        a_upper[5] = alpha_limit[0][5] * ratio;
        a_lower[0] = alpha_limit[1][0] * ratio;
        a_lower[1] = alpha_limit[1][1] * ratio;
        a_lower[2] = alpha_limit[0][2] * ratio;
        a_lower[3] = alpha_limit[1][3] * ratio;
        a_lower[4] = alpha_limit[1][4] * ratio;
        a_lower[5] = alpha_limit[1][5] * ratio;
