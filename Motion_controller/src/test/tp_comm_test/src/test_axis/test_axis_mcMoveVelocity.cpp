...
int main(int argc, char* argv[])
{
    if (argc <= 6)
    {
        cout << "6 parameters are needed: axis_id, direction, velocity, acc, dec, jerk" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x00016CF9;
    ...
    msg.data2.data[0] = atof(argv[3]);
    msg.data2.data[1] = atof(argv[4]);
    msg.data2.data[2] = atof(argv[5]);
    msg.data2.data[3] = atof(argv[6]);
