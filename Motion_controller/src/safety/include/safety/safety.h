#define	R_SAFETY_BASE	0X10	/* the address of date that read from safety, and 0x10 is a offset with a base 0xC1013000. */
#define	W_SAFETY_BASE	0X18	/* the address of date that written to safety, and 0x18 is a offset with a base C1013000. */
#define SAFETY_MAX_FRAME	5
#define R_SAFETY_MAX_FRAME	SAFETY_MAX_FRAME
#define W_SAFETY_MAX_FRAME	3
...
#define R_HB_FRAME		FIFTH_FRAME
#define	W_HB_FRAME		THIRD_FRAME
