...
int main()
{
    ...
    unsigned int hash_value = 0x00015F44;
    ...
    ResponseMessageType_Uint64_Uint64List msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&msg, ResponseMessageType_Uint64_Uint64List_fields, buf, buf_size))
    {
    ...
    if (msg.error_code.data != 0)
    {
        printf("Reply : get errorcode list failed!\n");
        return -1;
    }
