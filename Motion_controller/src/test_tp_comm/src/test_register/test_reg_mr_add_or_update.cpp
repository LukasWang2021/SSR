...
int main()
{
    ...
    cout << "Please cin hash type : "<< endl 
        << "1: /rpc/reg_manager/mr/addReg, hash = 0x000097E7;" << endl
        << "2: /rpc/reg_manager/mr/updateReg, hash = 0x0000E9B7" << endl;
    cin >> hash_cin;

    unsigned int hash_value = 0;
    if (1 == hash_cin)
        hash_value = 0x000097E7;
    else if (2 == hash_cin)
        hash_value = 0x0000E9B7;
    else
    {
    ...
    RequestMessageType_MrRegData msg;
    ...
    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_MrRegData_fields, buf, buf_size))
    {
