...
int main(int argc, char* argv[])
{
    if (argc <= 10)
    {
        cout << "10 parameters are needed: cpu, axis_id, eight int" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x0000C87F;
    ...
    {
        cout << "Reply : msg.data.data["<<recv_msg.data.data_count<<"] = " <<recv_msg.data.data[i] <<endl;
    }
