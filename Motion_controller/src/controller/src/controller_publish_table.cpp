...
void ControllerPublish::initPublishTable()
{
	...
	publish_service = {"/publish/controller/system_status",	0x000045C3,	&ControllerPublish::getSystemStatusPtr, &ControllerPublish::updateSystemStatusFdb}; publish_table_.push_back(publish_service);
