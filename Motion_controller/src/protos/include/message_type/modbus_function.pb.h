...
#define MessageType_ModbusFunctionInfo_init_default {(MessageType_ModbusFunctionType)0, 0, 0}
#define MessageType_ModbusFunctionAddrInfo_init_zero {0, 0}
#define MessageType_ModbusFunctionInfo_init_zero {(MessageType_ModbusFunctionType)0, 0, 0}

/* Field tags (for use in manual encoding/decoding) */
#define MessageType_ModbusFunctionAddrInfo_address_tag 2
#define MessageType_ModbusFunctionAddrInfo_number_tag 3
...
extern const pb_field_t MessageType_ModbusFunctionInfo_fields[4];

/* Maximum encoded size of messages (where known) */
#define MessageType_ModbusFunctionAddrInfo_size  22
#define MessageType_ModbusFunctionInfo_size      24
