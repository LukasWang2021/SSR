...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x0000B507;
    ...
    ResponseMessageType_Uint64_MrRegData recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg,ResponseMessageType_Uint64_MrRegData_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data.value = " << recv_msg.data.value << endl;
