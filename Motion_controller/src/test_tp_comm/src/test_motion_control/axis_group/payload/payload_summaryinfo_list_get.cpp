...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x00010C8F;
    ...
    ResponseMessageType_Uint64_PayloadSummaryList recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_PayloadSummaryList_fields, buf, buf_size))
    {
