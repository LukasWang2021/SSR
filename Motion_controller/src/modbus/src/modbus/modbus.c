                 ...
                 int req_length, modbus_mapping_t *mb_mapping)
{
    ...
    mb_mapping->last_change_addr = address;
    mb_mapping->last_function = function;
    mb_mapping->last_change_size = 0;
    sft.slave = slave;
    ...
    case MODBUS_FC_WRITE_SINGLE_REGISTER: {
        ...
        if (mapping_address < 0 || mapping_address >= mb_mapping->nb_registers) {
            ...
            mb_mapping->last_change_size = sizeof(uint16_t);
            memcpy(rsp, req, req_length);
            rsp_length = req_length;
        }
    }
    ...
    case MODBUS_FC_WRITE_MULTIPLE_COILS: {
        ...
        if (nb < 1 || MODBUS_MAX_WRITE_BITS < nb) {
            ...
            modbus_set_bits_from_bytes(mb_mapping->tab_bits, mapping_address, nb,
                                       &req[offset + 6]);
            mb_mapping->last_change_size = nb;
            rsp_length = ctx->backend->build_response_basis(&sft, rsp);
    ...
    case MODBUS_FC_WRITE_MULTIPLE_REGISTERS: {
        ...
        if (nb < 1 || MODBUS_MAX_WRITE_REGISTERS < nb) {
            ...
            mb_mapping->last_change_size = nb * 2;
            rsp_length = ctx->backend->build_response_basis(&sft, rsp);
    ...
    case MODBUS_FC_WRITE_AND_READ_REGISTERS: {
        ...
        if (nb_write < 1 || MODBUS_MAX_WR_WRITE_REGISTERS < nb_write ||
            ...
            mb_mapping->last_change_size = nb_write_bytes;
