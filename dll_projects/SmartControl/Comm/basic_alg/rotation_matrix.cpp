...
void RotationMatrix::multiplyByTransVector(Vector3& trans_vector, Vector3& result_vector) const
{
...
void RotationMatrix::getVectorN(Vector3& n_vector) const
{
...
void RotationMatrix::getVectorS(Vector3& s_vector) const
{
...
void RotationMatrix::getVectorA(Vector3& a_vector) const
{
