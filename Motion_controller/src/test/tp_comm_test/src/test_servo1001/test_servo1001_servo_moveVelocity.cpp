...
int main(int argc, char* argv[])
{
    if (argc <= 7)
    {
        cout << "7 parameters are needed: cpu, axis_id, velocity, acc, dec, jerk, direction" << endl;
        return -1;
    }
