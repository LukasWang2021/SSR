...
int main()
{
    ...
    unsigned int hash_value = 0x000003F5;
    ...
    ResponseMessageType_Uint64_Uint64 msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&msg, ResponseMessageType_Uint64_Uint64_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.error_code = " <<std::hex<< msg.error_code.data <<std::dec<< endl;
    cout << "Reply : msg.data = " << msg.data.data << endl;
