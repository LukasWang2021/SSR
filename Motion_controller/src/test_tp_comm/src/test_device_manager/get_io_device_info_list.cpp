...
int main()
{
    ...
    unsigned int hash_value = 0x000024A4;
    ...
    ResponseMessageType_Uint64_IoDeviceInfoList recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_IoDeviceInfoList_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.header.error_code = " << std::hex << recv_msg.header.error_code << endl;
    ...
    for (int i = 0; i != recv_msg.data.io_device_info_count; ++i)
    {
        ...
        cout << "Reply : msg.data.io_device_info["<< i <<"].device_index = " << recv_msg.data.io_device_info[i].device_index << endl;
        cout << "Reply : msg.data.io_device_info["<< i <<"].address = " << recv_msg.data.io_device_info[i].address << endl;
        cout << "Reply : msg.data.io_device_info["<< i <<"].input_num = " << recv_msg.data.io_device_info[i].input_num << endl;
        cout << "Reply : msg.data.io_device_info["<< i <<"].output_num = " << recv_msg.data.io_device_info[i].output_num << endl;
        cout << "Reply : msg.data.io_device_info["<< i <<"].is_valid = " << recv_msg.data.io_device_info[i].is_valid << endl;
    }
