...
/* Generated by nanopb-0.3.7-dev at Fri May  4 14:29:15 2018. */
...
const pb_field_t frame_spec_ActivateInterface_fields[2] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, frame_spec_ActivateInterface, id, id, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(frame_spec_PoseEuler, position) < 65536 && pb_membersize(frame_spec_PoseEuler, orientation) < 65536 && pb_membersize(frame_spec_Frame, data) < 65536 && pb_membersize(frame_spec_Interface, frame) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_frame_spec_Pose_frame_spec_Euler_frame_spec_PoseEuler_frame_spec_Frame_frame_spec_Interface_frame_spec_ActivateInterface)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(frame_spec_PoseEuler, position) < 256 && pb_membersize(frame_spec_PoseEuler, orientation) < 256 && pb_membersize(frame_spec_Frame, data) < 256 && pb_membersize(frame_spec_Interface, frame) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_frame_spec_Pose_frame_spec_Euler_frame_spec_PoseEuler_frame_spec_Frame_frame_spec_Interface_frame_spec_ActivateInterface)
#endif
