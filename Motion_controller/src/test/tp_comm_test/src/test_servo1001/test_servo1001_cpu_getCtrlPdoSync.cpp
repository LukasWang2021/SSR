...
int main(int argc, char* argv[])
{
    if (argc <= 2)
    {
        cout << "2 parameters are needed: cpu, axis_id" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x00005463;
    ...
    ResponseMessageType_Uint64_Int32_Uint32 recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_Int32_Uint32_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data1.data axid_id = " <<recv_msg.data1.data << endl;
    cout << "Reply : msg.data2.data sync = " <<recv_msg.data2.data << endl;
