...
typedef enum
{
    ...
    CONTROLLER_SERVER_CMD_GET_MI = 10,
    CONTROLLER_SERVER_CMD_SET_INSTRUCTION = 11,
    CONTROLLER_SERVER_CMD_IS_NEXT_INSTRUCTION_NEEDED = 12,
    CONTROLLER_SERVER_CMD_SET_INTERPRETER_SERVER_STATUS = 13,
    CONTROLLER_SERVER_CMD_GET_DI = 14,
    CONTROLLER_SERVER_CMD_SET_DI = 15,
    CONTROLLER_SERVER_CMD_GET_DO = 16,
    CONTROLLER_SERVER_CMD_SET_DO = 17,
    CONTROLLER_SERVER_CMD_GET_RI = 18,
    CONTROLLER_SERVER_CMD_SET_RI = 19,
    CONTROLLER_SERVER_CMD_GET_RO = 20,
    CONTROLLER_SERVER_CMD_SET_RO = 21,
    CONTROLLER_SERVER_CMD_GET_UI = 22,
    CONTROLLER_SERVER_CMD_SET_UI = 23,
    CONTROLLER_SERVER_CMD_GET_UO = 24,
}ControllerServerCmd;
