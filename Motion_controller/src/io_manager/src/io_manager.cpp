...
{
    std::stringstream ss;
    ss<<io_manager_VERSION_MAJOR<<"."
        <<io_manager_VERSION_MINOR<<"."
        <<io_manager_VERSION_PATCH;
    std::string s = ss.str();
...
IOManager::IOManager()
{
    ...
    std::cout<<"io_manager version:"<<getVersion()<<std::endl;
}
