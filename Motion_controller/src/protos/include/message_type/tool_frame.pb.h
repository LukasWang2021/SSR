...
#define MessageType_ToolInfo_init_default        {0, "", "", 0, MessageType_PoseEuler_init_default}
...
#define MessageType_ToolInfo_init_zero           {0, "", "", 0, MessageType_PoseEuler_init_zero}
...
#define MessageType_ToolInfo_size                371
