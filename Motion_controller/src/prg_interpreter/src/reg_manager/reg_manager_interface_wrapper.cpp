...
bool reg_manager_interface_setPr(fst_ctrl::PrRegData *ptr, uint16_t num)
{
	...
	if(g_objRegManagerInterface)
	{
		...
		FST_INFO("setPr: id = %d (%f, %f, %f, %f, %f, %f) with %s \n", num, 
