...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x00017F07;
    ...
    ResponseMessageType_Uint64_SrRegData recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_SrRegData_fields, buf, buf_size))
    {
