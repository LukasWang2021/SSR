...
#define ResponseMessageType_Bool_SrRegData_init_default {Request_Header_init_default, Comm_Property_init_default, MessageType_Bool_init_default, MessageType_SrRegData_init_default}
#define ResponseMessageType_Bool_SrRegData_init_zero {Request_Header_init_zero, Comm_Property_init_zero, MessageType_Bool_init_zero, MessageType_SrRegData_init_zero}
...
#define ResponseMessageType_Bool_SrRegData_size  585
