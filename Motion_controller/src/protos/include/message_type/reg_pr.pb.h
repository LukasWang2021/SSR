...
#define MessageType_PrRegData_init_default       {0, "", "", 0, 0, MessageType_DoubleList_init_default, MessageType_Int32List_init_default}
#define MessageType_PrRegData_init_zero          {0, "", "", 0, 0, MessageType_DoubleList_init_zero, MessageType_Int32List_init_zero}
...
#define MessageType_PrRegData_size               2924
