...
int main()
{
    ...
    unsigned int hash_value = 0x0000EAB7;
    ...
    ResponseMessageType_Uint64_RRegData recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg,ResponseMessageType_Uint64_RRegData_fields, buf, buf_size))
    {
