        ...
        for (int i = 0 ; i != msg.element_count; ++i)
        {
            ...
            switch (reg_type)
            {
                case MessageType_RegType_PR:
                {
                    ...
                    {
                        cout << "Sub : decode pr value falied !!" << endl;
                    }
                    else
                    {
                ...
                case MessageType_RegType_SR:
                {
                    ...
                    {
                        cout << "Sub : decode sr value falied !!" << endl;
                    }
                    else
                    {
                ...
                case MessageType_RegType_HR:
                {
                    ...
                    {
                        cout << "Sub : decode hr value falied !!" << endl;
                    }
                    else
                    {
                ...
                case MessageType_RegType_MR:
                {
                    ...
                    {
                        cout << "Sub : decode mr data falied !!" << endl;
                    }
                    else
                    {
                ...
                case MessageType_RegType_R:
                {
                    ...
                    {
                        cout << "Sub : decode r value falied !!" << endl;
                    }
                    else
                    {
