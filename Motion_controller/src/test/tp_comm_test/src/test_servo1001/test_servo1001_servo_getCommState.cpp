...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x0000F485;
    ...
    ResponseMessageType_Uint64_CoreCommState recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_CoreCommState_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data = 0x" <<recv_msg.data << endl;
