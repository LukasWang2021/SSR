...
#define MODBUS_LOG (unsigned long long int)0x0011000200B00000   /*ModbusManager log{0}*/																										
#define MODBUS_SAME_START_MODE (unsigned long long int)0x0001000200B00001   /*start mode is same to old*/																										
#define MODBUS_MANAGER_SAVE_PARAM_FAILED (unsigned long long int)0x0001000200B00002   /*modbus_manager save param failed*/																										
#define MODBUS_START_MODE_ERROR (unsigned long long int)0x0001000200B00003   /*modbus start mode error*/																										
#define MODBUS_INVALID (unsigned long long int)0x0001000200B00004   /*modbus invalid*/																										
#define MODBUS_CLIENT_MODE_INVALID (unsigned long long int)0x0001000200B00007   /*modbus start mode is not client*/																										
#define MODBUS_CLIENT_EXISTED (unsigned long long int)0x0001000200B00008   /*modbus client is existed*/																										
#define MODBUS_CLIENT_INVALID_ARG (unsigned long long int)0x0001000200B00009   /*modbus client param error*/																										
#define MODBUS_CLIENT_CONNECT_FAILED (unsigned long long int)0x0001000200B0000A   /*modbus client connect failed*/																										
#define MODBUS_CLIENT_LOAD_PARAM_FAILED (unsigned long long int)0x0001000200B0000C   /*modbus client load param failed*/																										
#define MODBUS_CLIENT_SAVE_PARAM_FAILED (unsigned long long int)0x0001000200B0000D   /*modbus client save param failed*/																										
#define MODBUS_CLIENT_INIT_FAILED (unsigned long long int)0x0001000200B0000F   /*modbus client init failed*/																										
#define MODBUS_CLIENT_READ_FAILED (unsigned long long int)0x0001000200B00010   /*modbus client read failed*/																										
#define MODBUS_CLIENT_WRITE_FAILED (unsigned long long int)0x0001000200B00011   /*modbus client write failed*/																										
#define MODBUS_CLIENT_BE_NOT_OPENED (unsigned long long int)0x0001000200B00012   /*modbus client be not opened*/																										
#define MODBUS_SERVER_BE_NOT_OPENED (unsigned long long int)0x0001000200B00019   /*modbus server is not be opened*/																										
#define MODBUS_SERVER_SAVE_PARAM_FALIED (unsigned long long int)0x0001000200B0001A   /*modbus server save param failed*/																										
#define MODBUS_SERVER_CONNECT_FALIED (unsigned long long int)0x0001000200B0001B   /*modbus server connect failed */																										
#define MODBUS_SERVER_INVALID_ARG (unsigned long long int)0x0001000200B0001C   /*modbus server invalid param*/																										
#define MODBUS_SERVER_LOAD_PARAM_FALIED (unsigned long long int)0x0001000200B0001D   /*modbus server load param failed*/																										
#define MODBUS_SERVER_OPEN_FAILED (unsigned long long int)0x0001000200B0001E   /*modbus server open failed*/																										
#define MODBUS_SERVER_INIT_FAILED (unsigned long long int)0x0001000200B0001F   /*modbus server init failed*/																										
