...
int main()
{
    ...
    unsigned int hash_value = 0x00010F54;
    ...
    ResponseMessageType_Uint64_AxisGroupInfoList recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_AxisGroupInfoList_fields, buf, buf_size))
    {
