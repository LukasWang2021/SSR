...
bool TrajParams::loadConstraint()
{
    ...
    if (!yaml_help_.loadParamFile(constraint_file_path_.c_str())
        ...
        || !yaml_help_.getParam("cart/position/stable/acc_max", position_acc_max_)
        || !yaml_help_.getParam("cart/position/stable/jerk_max_acc", position_jerk_max_[0])
        || !yaml_help_.getParam("cart/position/stable/jerk_max_dec", position_jerk_max_[2])
        || !yaml_help_.getParam("cart/position/stable/jerk_max_running", position_jerk_max_[1])
        || !yaml_help_.getParam("cart/position/swift/acc_max", position_acc_max_swift_)
        || !yaml_help_.getParam("cart/position/swift/jerk_max_acc", position_jerk_max_swift_[0])
        || !yaml_help_.getParam("cart/position/swift/jerk_max_running", position_jerk_max_swift_[1])
        || !yaml_help_.getParam("cart/position/swift/jerk_max_dec", position_jerk_max_swift_[2])
...
bool TrajParams::saveConstraint()
{
    ...
    if (!yaml_help_.setParam("joint/omega_max", omega_max)
        ...
        || !yaml_help_.setParam("cart/position/stable/acc_max", position_acc_max_)
        || !yaml_help_.setParam("cart/position/stable/jerk_max_acc", position_jerk_max_[0])
        || !yaml_help_.setParam("cart/position/stable/jerk_max_running", position_jerk_max_[1])
        || !yaml_help_.setParam("cart/position/stable/jerk_max_dec", position_jerk_max_[2])
        || !yaml_help_.setParam("cart/position/swift/acc_max", position_acc_max_swift_)
        || !yaml_help_.setParam("cart/position/swift/jerk_max_acc", position_jerk_max_swift_[0])
        || !yaml_help_.setParam("cart/position/swift/jerk_max_running", position_jerk_max_swift_[1])
        || !yaml_help_.setParam("cart/position/swift/jerk_max_dec", position_jerk_max_swift_[2])
