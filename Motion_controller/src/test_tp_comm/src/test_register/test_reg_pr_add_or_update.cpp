...
int main()
{
    ...
    cout << "Please cin hash type : "<< endl 
        << "1: /rpc/reg_manager/pr/addReg, hash = 0x000154E7;" << endl
        << "2: /rpc/reg_manager/pr/updateReg, hash = 0x00009EF7" << endl;
    cin >> hash_cin;

    unsigned int hash_value = 0;
    if (1 == hash_cin)
        hash_value = 0x000154E7;
    else if (2 == hash_cin)
        hash_value = 0x00009EF7;
    else
    {
    ...
    msg.data.posture.data[0] = true;
    msg.data.posture.data[1] = true;
    msg.data.posture.data[2] = true;
    msg.data.posture.data[3] = true;
    msg.data.posture.data[4] = true;
    msg.data.posture.data[5] = true;
    msg.data.posture.data[6] = true;
