...
int main()
{
    ...
    unsigned int hash_value = 0x000108E4;
    ...
    msg.limit.positive_limit.data[0] = 1.0;
    msg.limit.positive_limit.data[1] = 1.0;
    msg.limit.positive_limit.data[2] = 1.0;
    msg.limit.positive_limit.data[3] = 1.0;
    msg.limit.positive_limit.data[4] = 1.0;
    msg.limit.positive_limit.data[5] = 1.0;
    msg.limit.positive_limit.data[6] = 1.0;
    msg.limit.positive_limit.data[7] = 1.0;
    msg.limit.positive_limit.data[8] = 1.0;

    msg.limit.negative_limit.data[0] = 1.0;
    msg.limit.negative_limit.data[1] = 1.0;
    msg.limit.negative_limit.data[2] = 1.0;
    msg.limit.negative_limit.data[3] = 1.0;
    msg.limit.negative_limit.data[4] = 1.0;
    msg.limit.negative_limit.data[5] = 1.0;
    msg.limit.negative_limit.data[6] = 1.0;
    msg.limit.negative_limit.data[7] = 1.0;
    msg.limit.negative_limit.data[8] = 1.0;

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_Int32_JointLimit_fields, buf, buf_size))
    {
