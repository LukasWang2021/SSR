...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x00003E53;
    ...
    ResponseMessageType_Uint64_AxisStatus recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_AxisStatus_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data = " <<recv_msg.data << endl;
