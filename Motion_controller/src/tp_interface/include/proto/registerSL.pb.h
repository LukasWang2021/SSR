...
typedef struct _register_spec_IdListInterface {
    bool has_id_total;
    int32_t id_total;
    bool has_id;
    char id[10240];
/* @@protoc_insertion_point(struct:register_spec_IdListInterface) */
} register_spec_IdListInterface;
...
#define register_spec_IdListInterface_init_default {false, 0, false, ""}
...
#define register_spec_IdListInterface_init_zero  {false, 0, false, ""}

/* Field tags (for use in manual encoding/decoding) */
#define register_spec_Euler_a_tag                1
#define register_spec_Euler_b_tag                2
#define register_spec_Euler_c_tag                3
#define register_spec_IdListInterface_id_total_tag 1
#define register_spec_IdListInterface_id_tag     2
...
extern const pb_field_t register_spec_IdListInterface_fields[3];
...
#define register_spec_IdListInterface_size       10254
