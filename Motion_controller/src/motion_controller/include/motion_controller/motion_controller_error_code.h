...
#define ARM_GROUP_SUSPENDED (unsigned long long int)0x00010004006603FF   /*CANCELED:arm group in suspended state, call resume to jump out this state*/
#define ARM_GROUP_NOT_SUSPENDED (unsigned long long int)0x0001000400660400   /*CANCELED:arm group not in suspended state, cannot start resume function*/
