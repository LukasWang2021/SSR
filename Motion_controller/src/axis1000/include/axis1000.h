...
/**
 * @file axis1000.h
 * @brief The file is the header file of class "Axis1000" for servo motor.
 * @author youming.wu
 */
...
/**
 * @brief Axis1000 is the servo motor class.
