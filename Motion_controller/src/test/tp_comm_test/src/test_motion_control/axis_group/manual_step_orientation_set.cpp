...
int main(int argc, char* argv[])
{
    ...
    {
        cout << "more parameters are needed: orientation_step" << endl;
        return -1;
    }
    TpCommTest test;
    ...
    unsigned int hash_value = 0x00002940;

    RequestMessageType_Int32_Double msg;
    msg.header.time_stamp = 122;
    msg.property.authority = Comm_Authority_TP_SIMMULATOR;
    msg.data1.data = 0;
    msg.data1.data = atof(argv[1]);

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_Int32_Double_fields, buf, buf_size))
    {
