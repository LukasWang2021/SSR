...
void InterpreterServer::initRpcTable()
{
    ...
    rpc_service = {INTERPRETER_SERVER_CMD_GET_AUTO_START_MODE, &InterpreterServer::handleRequestGetAutoStartMode, &InterpreterServer::handleResponseGetAutoStartMode}; rpc_table_.push_back(rpc_service);
