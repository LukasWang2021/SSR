...
Turn KinematicsRTM::getTurnByJoint(const Joint& joint)
{
    ...
    if(joint.j1_ >= 0)
    {
        turn.j1 = (int)floor((fabs(joint.j1_) + M_PI) / (2 * M_PI));
    }
    else
    {
        turn.j1 = -(int)floor((fabs(joint.j1_) + M_PI) / (2 * M_PI));
    ...
    if(joint.j2_ >= 0)
    {
        turn.j2 = (int)floor((fabs(joint.j2_) + M_PI) / (2 * M_PI));
    }
    else
    {
        turn.j2 = -(int)floor((fabs(joint.j2_) + M_PI) / (2 * M_PI));
    ...
    if(joint.j3_ >= 0)
    {
        turn.j3 = (int)floor((fabs(joint.j3_) + M_PI) / (2 * M_PI)); 
    }
    else
    {
        turn.j3 = -(int)floor((fabs(joint.j3_) + M_PI) / (2 * M_PI));
    ...
    if(joint.j4_ >= 0)
    {
        turn.j4 = (int)floor((fabs(joint.j4_) + M_PI) / (2 * M_PI));
    }
    else
    {
        turn.j4 = -(int)floor((fabs(joint.j4_) + M_PI) / (2 * M_PI));
    ...
    if(joint.j5_ >= 0)
    {
        turn.j5 = (int)floor((fabs(joint.j5_) + M_PI) / (2 * M_PI));
    }
    else
    {
        turn.j5 = -(int)floor((fabs(joint.j5_) + M_PI) / (2 * M_PI));
    ...
    if(joint.j6_ >= 0)
    {
        turn.j6 = (int)floor((fabs(joint.j6_) + M_PI) / (2 * M_PI));
    }
    else
    {
        turn.j6 = -(int)floor((fabs(joint.j6_) + M_PI) / (2 * M_PI));
