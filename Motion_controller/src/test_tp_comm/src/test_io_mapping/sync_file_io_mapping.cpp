...
int main()
{
    ...
    unsigned int hash_value = 0x0000C2A7;

    RequestMessageType_StringList msg;
    msg.header.time_stamp = 122;
    msg.property.authority = Comm_Authority_TP;
    msg.data.data_count = 1;
    char data[256] = "io_mapping";
    memcpy(msg.data.data[0].data, data, sizeof(data));

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_StringList_fields, buf, buf_size))
    {
