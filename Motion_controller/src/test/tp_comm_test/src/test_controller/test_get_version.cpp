...
int main()
{
    ...
    ResponseMessageType_Uint64_Uint32List msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&msg, ResponseMessageType_Uint64_Uint32List_fields, buf, buf_size))
    {
