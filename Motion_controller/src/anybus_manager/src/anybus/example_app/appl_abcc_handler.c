...
void ABCC_CbfUserInitReq( void )
{
   ...
   if (iNetworkType == ABP_NW_TYPE_DEV )
   {
         printf("NetWork is ABP_NW_TYPE_DEV\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_PDPV0 )
   {
         printf("NetWork is ABP_NW_TYPE_PDPV0\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_PDPV1 )
   {
         printf("NetWork is ABP_NW_TYPE_PDPV1\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_COP )
   {
         printf("NetWork is ABP_NW_TYPE_COP\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_CNT )
   {
         printf("NetWork is ABP_NW_TYPE_CNT\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_CCL )
   {
         printf("NetWork is ABP_NW_TYPE_CCL\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_CFN )
   {
         printf("NetWork is ABP_NW_TYPE_CFN\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_ECT )
   {
         printf("NetWork is ABP_NW_TYPE_DEV\n");
   }
   else if (iNetworkType == ABP_NW_TYPE_EPL )
   {
         printf("NetWork is ABP_NW_TYPE_EPL\n");
   }
   else
   {
