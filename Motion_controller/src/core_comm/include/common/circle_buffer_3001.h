#ifndef CIRCLE_BUFFER_3001_H
#define CIRCLE_BUFFER_3001_H

/**
 * @file circle_buffer_3001.h
 * @brief The file includes the definition of the data type for circle buffer 3001 channel.
 * @author feng.wu
 */
 ...
 * @details Circle buffer 3001 is a circular buffer which is designed for handling feedback process data.\n
 */
typedef struct
{
...
}CircleBufferAppData3001_t;

/**
 * @brief Initialize the circle buffer 3001 channel.
 ...
 * @return void
 */
void initCircleBuffer3001(CommBlockData_t* block_ptr);
