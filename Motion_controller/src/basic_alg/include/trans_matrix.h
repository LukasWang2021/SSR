...
public:
    ...
    void leftMultiply(const TransMatrix& left_matrix, TransMatrix& result_matrix);
    TransMatrix& rightMultiply(const TransMatrix& right_matrix);
    void rightMultiply(const TransMatrix& right_matrix, TransMatrix& result_matrix);
...
private:
    void multiply(const TransMatrix& left_matrix, const TransMatrix& right_matrix, TransMatrix& result_matrix);
};
