...
int main(int argc, char** argv)
{
    ...
    RequestMessageType_ModbusServerStartInfo msg;
    ...
    unsigned int hash_value = 0x0001300F;

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_ModbusServerStartInfo_fields, buf, buf_size))
    {
