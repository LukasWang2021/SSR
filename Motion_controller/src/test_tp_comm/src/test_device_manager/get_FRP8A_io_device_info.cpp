...
int main()
{
    ...
    unsigned int hash_value = 0x00006BAF;
    ...
    ResponseMessageType_Uint64_IoDeviceInfo recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_IoDeviceInfo_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data.device_type = " << recv_msg.data.device_type << endl;
    cout << "Reply : msg.data.comm_type = " << recv_msg.data.comm_type << endl;
    cout << "Reply : msg.data.device_index = " << recv_msg.data.device_index << endl;
    cout << "Reply : msg.data.address = " << recv_msg.data.address << endl;
    cout << "Reply : msg.data.input_num = " << recv_msg.data.input_num << endl;
    cout << "Reply : msg.data.output_num = " << recv_msg.data.output_num << endl;
    cout << "Reply : msg.data.is_valid = " << recv_msg.data.is_valid << endl;
