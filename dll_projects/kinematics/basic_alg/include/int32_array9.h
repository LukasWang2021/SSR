#ifndef INT32_ARRAY9_H
#define INT32_ARRAY9_H

/**
 * @file int32_array9.h
 * @brief The file is the header file of class "Int32Array9".
 * @author zhengyu.shen
 */
...
{
/**
 * @brief Int32Array9 can represent any object that has up to 9 int32_t elements.
 * @details Int32Array9 includes 9 int32_t elements in it.
 */
class Int32Array9
{
public:
    int32_t   a0_;   /**< the first element.*/
    int32_t   a1_;   /**< the second element.*/
    int32_t   a2_;   /**< the third element.*/
    int32_t   a3_;   /**< the fourth element.*/
    int32_t   a4_;   /**< the fifth element.*/
    int32_t   a5_;   /**< the sixth element.*/
    int32_t   a6_;   /**< the seventh element.*/
    int32_t   a7_;   /**< the eighth element.*/
    int32_t   a8_;   /**< the ninth element.*/
     ...
     * @retval true All expected elements between the array object and the comparing one are the same.
     * @retval false  At least one expected element between the array object and the comparing one is not same.
     */
    bool isEqual(Int32Array9& array, size_t element_number) const;
     ...
     */    
    const Int32Array9 operator+(const Int32Array9& array);
    /**
     * @brief Operator- overload.
     * @details Do math operation: this - array.\n
     *          a0_new = a0_ - array.a0_;\n
     ...
     */     
    Int32Array9& operator+=(const Int32Array9& array);
    /**
     * @brief Operator- overload.
     * @details Do math operation: this = this - array.\n
     *          this.a0_ = this.a0_ - joint.a0_;\n
