...
int main()
{
    ...
    unsigned int hash_value = 0x00005E1F;
    ...
    cout << "Reply : msg.data.discrepte_input.address = " << recv_msg.data.discrepte_input.address << endl;
    cout << "Reply : msg.data.discrepte_input.number = " << recv_msg.data.discrepte_input.number << endl;
    cout << "Reply : msg.data.holding_reg.address = " << recv_msg.data.holding_reg.address << endl;
    cout << "Reply : msg.data.holding_reg.number = " << recv_msg.data.holding_reg.number << endl;
    cout << "Reply : msg.data.input_reg.address = "<< recv_msg.data.input_reg.address << endl;
    cout << "Reply : msg.data.input_reg.number = " << recv_msg.data.input_reg.number << endl;
