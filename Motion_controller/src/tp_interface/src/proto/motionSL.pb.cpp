...
const pb_field_t motion_spec_StartCtrl_fields[2] = {
    PB_FIELD(  1, STRING  , REQUIRED, CALLBACK, FIRST, motion_spec_StartCtrl, name, name, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(motion_spec_WayPoint, pose) < 65536 && pb_membersize(motion_spec_MoveL, waypoints[0]) < 65536 && pb_membersize(motion_spec_MoveC, pose1) < 65536 && pb_membersize(motion_spec_MoveC, pose2) < 65536 && pb_membersize(motion_spec_TeachPose, pose) < 65536 && pb_membersize(motion_spec_ManualCommand, target) < 65536 && pb_membersize(motion_spec_MotionProgram, commandlist[0]) < 65536 && pb_membersize(motion_spec_DeviceList, dev_info[0]) < 65536 && pb_membersize(motion_spec_JointConstraint, jntLmt[0]) < 65536 && pb_membersize(motion_spec_DHGroup, coord_offset[0]) < 65536 && pb_membersize(motion_spec_SignalGroup, sig_param[0]) < 65536 && pb_membersize(motion_spec_SignalGroup, fifo[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_motion_spec_StartCtrl_motion_spec_Pose_motion_spec_ToolTipOffset_motion_spec_WayPoint_motion_spec_MoveL_motion_spec_MoveC_motion_spec_MoveJ_motion_spec_TeachPose_motion_spec_TeachTarget_motion_spec_ManualCommand_motion_spec_userFrame_motion_spec_toolFrame_motion_spec_Set_motion_spec_Get_motion_spec_Wait_motion_spec_MotionCommand_motion_spec_MotionProgram_motion_spec_DeviceList_motion_spec_DeviceInfo_motion_spec_JointLimit_motion_spec_JointConstraint_motion_spec_CoordinateOffset_motion_spec_DHGroup_motion_spec_Signal_motion_spec_SignalGroup_motion_spec_FIFOData)
#endif
