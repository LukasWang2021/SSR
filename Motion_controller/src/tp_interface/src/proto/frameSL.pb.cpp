...
const pb_field_t frame_spec_SimpleFrame_fields[3] = {
    PB_FIELD(  1, INT32   , OPTIONAL, STATIC  , FIRST, frame_spec_SimpleFrame, id, id, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, frame_spec_SimpleFrame, comment, id, 0),
    PB_LAST_FIELD
};

const pb_field_t frame_spec_SimpleFrameInterface_fields[3] = {
    PB_FIELD(  1, INT32   , OPTIONAL, STATIC  , FIRST, frame_spec_SimpleFrameInterface, total_frame, total_frame, 0),
    PB_FIELD(  2, MESSAGE , REPEATED, STATIC  , OTHER, frame_spec_SimpleFrameInterface, frame, total_frame, &frame_spec_SimpleFrame_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(frame_spec_PoseEuler, position) < 65536 && pb_membersize(frame_spec_PoseEuler, orientation) < 65536 && pb_membersize(frame_spec_Frame, data) < 65536 && pb_membersize(frame_spec_Interface, frame) < 65536 && pb_membersize(frame_spec_SimpleFrameInterface, frame[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_frame_spec_Pose_frame_spec_Euler_frame_spec_PoseEuler_frame_spec_Frame_frame_spec_Interface_frame_spec_ActivateInterface_frame_spec_SimpleFrame_frame_spec_SimpleFrameInterface)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(frame_spec_PoseEuler, position) < 256 && pb_membersize(frame_spec_PoseEuler, orientation) < 256 && pb_membersize(frame_spec_Frame, data) < 256 && pb_membersize(frame_spec_Interface, frame) < 256 && pb_membersize(frame_spec_SimpleFrameInterface, frame[0]) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_frame_spec_Pose_frame_spec_Euler_frame_spec_PoseEuler_frame_spec_Frame_frame_spec_Interface_frame_spec_ActivateInterface_frame_spec_SimpleFrame_frame_spec_SimpleFrameInterface)
#endif
