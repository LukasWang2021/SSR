...
#define ResponseMessageType_Bool_HrRegData_init_default {Response_Header_init_default, Comm_Property_init_default, MessageType_Bool_init_default, MessageType_HrRegData_init_default}
#define ResponseMessageType_Bool_HrRegData_init_zero {Response_Header_init_zero, Comm_Property_init_zero, MessageType_Bool_init_zero, MessageType_HrRegData_init_zero}
...
#define ResponseMessageType_Bool_HrRegData_size  2671
