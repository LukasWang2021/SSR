...
if(NOT "/home/fst/workspace/src/log_service/include " STREQUAL " ")
  set(log_service_INCLUDE_DIRS "")
  set(_include_dirs "/home/fst/workspace/src/log_service/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'log_service' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fst/workspace/src/log_service/${idir}'.  Ask the maintainer 'fst <fst@todo.todo>' to fix it.")
    endif()
