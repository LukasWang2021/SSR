...
int main(int argc, char **argv)
{
    ...
    bool res;
    res = group.MoveJ(jnt2,4000,32000, 1061,err);
    res = group.MoveL(posee1,300,32000,100, posee2,300,32000,100, 1064,err);
    res = group.MoveL(posee2,300,32000,50, jnt1,4000,32000,0, 1065,err);
