...
int main()
{
    ...
    unsigned int hash_value = 0x00016994;

    RequestMessageType_Int32List_DoubleList send_msg;
    send_msg.header.time_stamp = 122;
    send_msg.property.authority = Comm_Authority_TP;

    send_msg.data1.data_count = 3;
    send_msg.data1.data[0] = 3;
    send_msg.data1.data[1] = 3;
    send_msg.data1.data[2] = 3;
    ...
    if (!test.generateRequestMessageType(hash_value, (void*)&send_msg, RequestMessageType_Int32List_DoubleList_fields, buf, buf_size))
    {
