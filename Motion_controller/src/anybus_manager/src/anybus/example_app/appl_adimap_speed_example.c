...
static UINT16 appl_Line;

static UINT16 appl_state[8];
/*------------------------------------------------------------------------------
...
const AD_AdiEntryType APPL_asAdiEntryList[] =
{
   ...
   {  0x3,  "Line", ABP_UINT16,   1, APPL_READ_MAP_WRITE_ACCESS_DESC, { { &appl_Line, &appl_sUint16Prop } } },
   {  0x4,  "State", ABP_UINT16,   8, APPL_READ_MAP_READ_ACCESS_DESC, { { &appl_state, &appl_sUint16Prop } } }
};
