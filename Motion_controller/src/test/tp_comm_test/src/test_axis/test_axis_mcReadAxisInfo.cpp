...
int main(int argc, char* argv[])
{
    if (argc <= 1)
    {
        cout << "1 parameters are needed: axis_id" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x0000314F;
    ...
    ResponseMessageType_Uint64_AxisInfo recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_AxisInfo_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data.simulation = " <<recv_msg.data.simulation << endl;
    cout << "Reply : msg.data.communication_ready = " <<recv_msg.data.communication_ready << endl;
    cout << "Reply : msg.data.ready_for_power_on = " <<recv_msg.data.ready_for_power_on << endl;
    cout << "Reply : msg.data.power_on = " <<recv_msg.data.power_on << endl;
