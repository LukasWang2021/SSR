...
int main(int argc, char* argv[])
{
    if (argc <= 3)
    {
        cout << "3 parameters are needed: cpu, axis_id, CoreCommState" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x000153C5;

    RequestMessageType_Int32List_CoreCommState msg;
    ...
    msg.data2 = (MessageType_CoreCommState)(atoi(argv[3]));

    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_Int32List_CoreCommState_fields, buf, buf_size))
    {
