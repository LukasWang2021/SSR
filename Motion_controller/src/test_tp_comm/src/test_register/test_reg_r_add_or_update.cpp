...
int main()
{
    ...
    cout << "Please cin hash type : "<< endl 
        << "1: /rpc/reg_manager/r/addReg, hash = 0x00004FF7;" << endl
        << "2: /rpc/reg_manager/r/updateReg, hash = 0x00005757" << endl;
    cin >> hash_cin;

    unsigned int hash_value = 0;
    if (1 == hash_cin)
        hash_value = 0x00004FF7;
    else if (2 == hash_cin)
        hash_value = 0x00005757;
    else
    {
    ...
    RequestMessageType_RRegData msg;
    ...
    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_RRegData_fields, buf, buf_size))
    {
