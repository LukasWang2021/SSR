...
int main(int argc, char* argv[])
{
    ...
    {
        cout << "more parameters are needed : register id." << endl;
        return -1;
    }
    ...
    cout << "Reply : msg.error_code = 0x" << std::hex << recv_msg.error_code.data << endl;
    ...
    printf("name_size = %d, comment_size = %d\n", name_size, comment_size);
