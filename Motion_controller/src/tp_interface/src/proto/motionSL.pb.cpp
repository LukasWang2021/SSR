...
const pb_field_t motion_spec_WayPoint_fields[6] = {
...
const pb_field_t motion_spec_MoveL_fields[6] = {
    ...
    PB_FIELD(  2, DOUBLE  , REQUIRED, STATIC  , OTHER, motion_spec_MoveL, aMax, vMax, 0),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(motion_spec_WayPoint, pose) < 65536 && pb_membersize(motion_spec_MoveL, waypoints[0]) < 65536 && pb_membersize(motion_spec_MotionProgram, commandlist[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_motion_spec_Pose_motion_spec_ToolTipOffset_motion_spec_WayPoint_motion_spec_MoveL_motion_spec_MoveJ_motion_spec_Set_motion_spec_Get_motion_spec_Wait_motion_spec_MotionCommand_motion_spec_MotionProgram)
#endif

#if !defined(PB_FIELD_16BIT) && !defined(PB_FIELD_32BIT)
#error Field descriptor for motion_spec_MotionCommand.commandarguments is too large. Define PB_FIELD_16BIT to fix this.
#endif
