...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x0000B695;
    ...
    ResponseMessageType_Uint64_Uint32 recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_Uint32_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data.data = " <<std::hex<<recv_msg.data.data <<std::dec<< endl;
    cout << "Reply : msg.error_code.data = " <<std::hex<<recv_msg.error_code.data <<std::dec<< endl;
