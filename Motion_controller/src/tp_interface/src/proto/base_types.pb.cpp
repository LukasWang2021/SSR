...
const pb_field_t BaseTypes_ParameterOverwriteMsg_fields[6] = {
    ...
    PB_FIELD(  2, STRING  , OPTIONAL, CALLBACK, OTHER, BaseTypes_ParameterOverwriteMsg, path, header, 0),
    ...
    PB_FIELD(  5, BYTES   , REQUIRED, CALLBACK, OTHER, BaseTypes_ParameterOverwriteMsg, param, number_of_elements, 0),
    PB_LAST_FIELD
};
