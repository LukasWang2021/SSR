...
public:
	...
	void planTrajectory(const basic_alg::PoseQuaternion &start, const basic_alg::PoseQuaternion &via, const basic_alg::PoseQuaternion &end, double vel, double acc, double jerk);
