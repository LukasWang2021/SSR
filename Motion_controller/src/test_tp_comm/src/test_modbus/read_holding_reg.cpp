...
int main(int argc, char** argv)
{
    ...
    unsigned int hash_value = 0x00003583;
    ...
    ResponseMessageType_Uint64_ModbusRegInfo recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_ModbusRegInfo_fields, buf, buf_size))
    {
    ...
    for (int i = 0; i != recv_msg.data.value_count; ++i)
    {
