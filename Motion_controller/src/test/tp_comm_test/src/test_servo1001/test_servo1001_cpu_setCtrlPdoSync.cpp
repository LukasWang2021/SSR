...
int main(int argc, char* argv[])
{
    if (argc <= 3)
    {
        cout << "3 parameters are needed: cpu, axis_id, cpu_pdo_sync" << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x00005123;

    RequestMessageType_Int32List_Uint32 msg;
    ...
    if (!test.generateRequestMessageType(hash_value, (void*)&msg, RequestMessageType_Int32List_Uint32_fields, buf, buf_size))
    {
