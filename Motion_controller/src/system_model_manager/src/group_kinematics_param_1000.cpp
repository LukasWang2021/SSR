    ...
    ModelBase(MODEL_TYPE_GROUP_KINEMATICS, style_str, file_path, &param_[0], GroupKinematics1000__number)
{
    ...
    addParam("D4",                GroupKinematics1000__D4);
    addParam("D5",                GroupKinematics1000__D5);
    ...
    addParam("A4",                GroupKinematics1000__A4);
    addParam("A5",                GroupKinematics1000__A5);
    ...
    addParam("ALPHA4",            GroupKinematics1000__ALPHA4);
    addParam("ALPHA5",            GroupKinematics1000__ALPHA5);
    ...
    addParam("THETA4",            GroupKinematics1000__THETA4);
    addParam("THETA5",            GroupKinematics1000__THETA5);
    ...
    addParam("D4_offset",         GroupKinematics1000__D4_offset);
    addParam("D5_offset",         GroupKinematics1000__D5_offset);
    ...
    addParam("A4_offset",         GroupKinematics1000__A4_offset);
    addParam("A5_offset",         GroupKinematics1000__A5_offset);
    ...
    addParam("ALPHA4_offset",     GroupKinematics1000__ALPHA4_offset);
    addParam("ALPHA5_offset",     GroupKinematics1000__ALPHA5_offset);
    ...
    addParam("THETA4_offset",     GroupKinematics1000__THETA4_offset);
    addParam("THETA5_offset",     GroupKinematics1000__THETA5_offset);
}
