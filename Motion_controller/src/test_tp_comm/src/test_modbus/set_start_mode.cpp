...
int main(int argc, char** argv)
{
    ...
    //msg.data.start_mode = static_cast<MessageType_ModbusStartModeType>(start_mode);
    printf("start mode set = %d\n", msg.data.data);

    unsigned int hash_value = 0x0000D3A5;
    ...
    cout << "Reply : msg.data.data = \n" << std::hex << recv_msg.data.data << endl;
