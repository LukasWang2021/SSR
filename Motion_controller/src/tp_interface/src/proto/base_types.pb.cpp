...
/* Generated by nanopb-0.3.7-dev at Mon Aug 15 02:38:48 2016. */
...
const pb_field_t BaseTypes_ParameterListMsg_fields[3] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, STATIC  , OTHER, BaseTypes_ParameterListMsg, params, header, &BaseTypes_ParameterMsg_fields),
    PB_LAST_FIELD
};
