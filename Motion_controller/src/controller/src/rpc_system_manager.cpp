...
void ControllerRpc::handleRpc0x00016008(void* request_data_ptr, void* response_data_ptr)
{
    ...
    recordLog(SYSTEM_MANAGER_LOG, rs_data_ptr->data.data, std::string("/rpc/system_manager/moveFinish"));
...
void ControllerRpc::handleRpc0x00011CE8(void* request_data_ptr, void* response_data_ptr)
{
    ...
    recordLog(SYSTEM_MANAGER_LOG, rs_data_ptr->data.data, std::string("/rpc/system_manager/restoreFininsh"));
