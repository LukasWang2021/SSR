...
/* Generated by nanopb-0.3.7-dev at Wed May 23 10:46:30 2018. */
...
const pb_field_t register_spec_IdListInterface_fields[3] = {
    PB_FIELD(  1, INT32   , OPTIONAL, STATIC  , FIRST, register_spec_IdListInterface, id_total, id_total, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, register_spec_IdListInterface, id, id_total, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(register_spec_PoseEuler, position) < 65536 && pb_membersize(register_spec_PoseEuler, orientation) < 65536 && pb_membersize(register_spec_PRInterface, pose) < 65536 && pb_membersize(register_spec_PRInterface, joint) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_register_spec_Point_register_spec_Euler_register_spec_PoseEuler_register_spec_Joint_register_spec_PRInterface_register_spec_SRInterface_register_spec_NRInterface_register_spec_MRInterface_register_spec_IdListInterface)
#endif

#if !defined(PB_FIELD_16BIT) && !defined(PB_FIELD_32BIT)
#error Field descriptor for register_spec_IdListInterface.id is too large. Define PB_FIELD_16BIT to fix this.
#endif
