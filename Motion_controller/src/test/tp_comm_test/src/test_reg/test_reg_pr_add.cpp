...
int main(int argc, char* argv[])
{
    ...
    {
        cout << "more parameters are needed : id, name, comment size, group id." << endl;
        return -1;
    }
    ...
    unsigned int hash_value = 0x000154E7;
    ...
    msg.data.group_id = atoi(argv[4]);
    msg.data.pos_type = 1;
    msg.data.pos.data_count = 9;
    msg.data.pos.data[0] = 0.1;
    msg.data.pos.data[1] = 0.2;
    msg.data.pos.data[2] = 0.3;
    msg.data.pos.data[3] = 0.4;
    msg.data.pos.data[4] = 0.5;
    msg.data.pos.data[5] = 0.6;
    msg.data.pos.data[6] = 0.7;

    msg.data.posture.wrist_flip = 1;
    msg.data.posture.arm_up_down = -1;
    msg.data.posture.arm_back_front = 1;
    msg.data.posture.arm_left_right = 1;//for diff model
