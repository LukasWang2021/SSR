...
int main()
{
    ...
    unsigned int hash_value = 0x000092E5;
    ...
    ResponseMessageType_Uint64_Int32 msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&msg, ResponseMessageType_Uint64_Int32_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.error_code.data = " << msg.error_code.data << endl;
