...
int main(int argc, char* argv[])
{
    ...
    unsigned int hash_value = 0x00010C34;
    ...
    ResponseMessageType_Uint64_PayloadInfo recv_msg;
    unsigned int recv_hash = 0;
    if (!test.decodeResponseMessageType(recv_hash, (void*)&recv_msg, ResponseMessageType_Uint64_PayloadInfo_fields, buf, buf_size))
    {
    ...
    cout << "Reply : msg.data.weight = " << recv_msg.data.weight << endl;
