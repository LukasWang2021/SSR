...
int main(int argc, char** argv)
{
    ...
    unsigned int hash_value = 0x00008C43;

    RequestMessageType_Int32_ModbusRegInfo msg;
    ...
    uint16_t value_0 = atoi(argv[5]);
    uint16_t value_1 = atoi(argv[6]);
    uint16_t value_2 = atoi(argv[7]);
    ...
    printf("value_0 = %x; address = %x; value_2 = %x\n",
