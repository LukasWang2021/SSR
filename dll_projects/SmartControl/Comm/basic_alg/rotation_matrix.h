 ...
 * @brief The file is the header file of class "RotationMatrix".
 * @author zhengyu.shen
 */
...
public:
     ...
     * @return void
     */
    void multiplyByTransVector(Vector3& trans_vector, Vector3& result_vector) const;
    /**
     ...
     * @return void
     */     
    void getVectorN(Vector3& n_vector) const;
    /**
     ...
     * @return void
     */
    void getVectorS(Vector3& s_vector) const;
    /**
     ...
     * @return void
     */    
    void getVectorA(Vector3& a_vector) const;
