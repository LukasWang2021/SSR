...
const char * FileOperations::passphrase_ = "fst_robot_2048";
...
//------------------------------------------------------------
U64 FileOperations::archiveCreate(const char **source, const char *destination)
{
    struct archive *a;
...
//------------------------------------------------------------
U64 FileOperations::archiveExtract(const char *source, const char *destination)
{
    struct archive *a;
    struct archive *ext;
    struct archive_entry *entry;
